...
- Reflects Napkin API considerations (Bearer auth, ~30‑minute URL expiry)
...
| Napkin API 101 | `docs/napkin-api-101.md` | Napkin API overview |
| Create Visual Request | `docs/napkin-api-create-visual-request.md` | Visual creation request |
| Regenerate Visual | `docs/napkin-api-regenerate-visual.md` | Visual regeneration |
| Get Visual Status | `docs/napkin-api-get-visual-request-status.md` | Status retrieval |
...
docs/
  napkin-api-*.md          # Local API docs (101, styles, endpoints, changelog)
